  ...
  return (
    <React.Fragment>
      <div className="bmc-card-full">
        ...
        <PersonalDetailCard castes={castes} religions={religions} onUpdate={handlePersonalDetailUpdate} initialRows={addhardata.aadhaarInfo} tenantId={tenantId} headerLocale={headerLocale} AllowEdit={true}></PersonalDetailCard>
        <AddressDetailCard onUpdate={handleAddressUpdate} initialRows={addhardata.aadhaarInfo} tenantId={tenantId} headerLocale={headerLocale} AllowEdit={true}></AddressDetailCard>
        ...
        {selectedOptionCard.value === "Yes" && (
          <DisabilityCard onUpdate={handleDisabilityUpdate} initialRows={[]} AllowEdit={true}></DisabilityCard>
        )}
