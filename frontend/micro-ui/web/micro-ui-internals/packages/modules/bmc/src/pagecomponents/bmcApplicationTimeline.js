import { CardSectionHeader, CheckPoint, ConnectingCheckPoints, Loader, SubmitBar } from "@egovernments/digit-ui-react-components";
import React, { Fragment } from "react";
import { useTranslation } from "react-i18next";
import { Link } from "react-router-dom";
import BMCCaption from "./bmcCaption";


const BMCApplicationTimeline = (props) => {
  ...
  const getTimelineCaptions = (checkpoint) => {
    ...
    if (checkpoint.state === "OPEN")
    {
      ...
      return <BMCCaption data={caption} />;
    }
      ...
      return <BMCCaption data={caption} OpenImage={OpenImage} />;
    } 
...
export default BMCApplicationTimeline;