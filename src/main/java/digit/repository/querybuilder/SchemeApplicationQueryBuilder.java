...
public class SchemeApplicationQueryBuilder {
    ...
    private static final String ADDRESS_SELECT_QUERY = "addr.ID as addr_id, addr.userid as addr_userid, addr.tenantid as addr_tenantid, " +
    ...
    private static final String USER_SELECT_QUERY = "u.username as user_username, u.name as user_name, u.emailid as user_email, " +
    ...
    private static final String FROM_TABLES = "FROM eg_bmc_UserSchemeApplication usa " +
